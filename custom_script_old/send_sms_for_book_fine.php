...
mysqli_set_charset($conn, "utf8");
 ...
 $sql = "SELECT a.UserId, b.name UserName, a.BookId, c.BookName, b.phone, a.IssueDate, DATEDIFF(NOW(),a.IssueDate) IssuedDay
...
function send_sms($number, $userName, $books){
	...
	$message="Hello $userName, You can not return $books book timely. As fine 1000 TK every book.";
	$data= array(
		'username'=>"pilot",
		'password'=>"Z2PE7AY3",
		'number'=>"$number",
