...
@section('titlename') Book Type Entry @endsection
		...
		<section class="bg-section ysuccess pt-10 pb-10" data-black-overlay="8" style="background-image: url({{ asset('public/images/background/bg-2.jpg') }})">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						<i class="fa fa-home white"></i> <span> / Admin / Book Type Entry</span>	
					</div>
					...
					<div class="row">
						<div class="col-lg-12">	
							<table id="tableMain" class="table table-striped table-bordered" style="width:100%">
								<thead>
									<tr>
										<th style="display:none;">Book TypeId</th>
										<th>Serial</th>
										<th>Book Type</th>
										<th>Action</th>
									</tr>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control parsley-validated" name="BookType" id="BookType" data-required="true" placeholder="Enter Book Type">
												</div>
											</div>
										</div>
...
jQuery("#addeditform").parsley({
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        ...
	        url: SITEURL+"/addEditBookTypeRoute",
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
            ...
            url: SITEURL+"/deleteBookTypeRoute",
	...
	$(document).ready(function() {
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('booktypetabledatafetch') ?>",
		        "datatype": "json",
		        "type": "post",
		    ...
		    "fnDrawCallback" : function(oSettings) {
		                    ...
		                    $.confirm({
		                        ...
		                        buttons: {
		                            confirm: function () {
		                                ...
		                                resetForm("addeditform");
		                                $('#recordId').val(aData['BookTypeId']);
		                                $('#BookType').val(aData['BookType']);
		            ...
		            $('a.itmDrop', tableMain.fnGetNodes()).each(function() {
		                ...
		                $(this).click(function() {
		                    ...
		                    buttons: {
		                        confirm: function () {
		                            onConfirmWhenDelete(aData['BookTypeId']);
		                        },
		                        cancel: function () {
		                            //$.alert('Canceled!');
		                        }
