...
@section('titlename') Department Entry @endsection
		...
		<section class="bg-section ysuccess pt-10 pb-10" data-black-overlay="8" style="background-image: url({{ asset('public/images/background/bg-2.jpg') }})">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						<i class="fa fa-home white"></i> <span> / Admin / Department Entry</span>	
					</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control parsley-validated" name="Department" id="Department" data-required="true" placeholder="Enter Department">
												</div>
											</div>
										</div>
...
jQuery("#addeditform").parsley({
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        type: "post",
	        url: SITEURL+"/addEditDepartmentRoute",
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
            type: "post",
            url: SITEURL+"/deleteDepartmentRoute",
	...
	$(document).ready(function() {
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('departmenttabledatafetch') ?>",
		        "datatype": "json",
		        "type": "post",
		    ...
		    "fnDrawCallback" : function(oSettings) {
		                    ...
		                    $.confirm({
		                        ...
		                        buttons: {
		                            confirm: function () {
		                                ...
		                                resetForm("addeditform");
		                                $('#recordId').val(aData['DepartmentId']);
		                                $('#Department').val(aData['Department']);
		            ...
		            $('a.itmDrop', tableMain.fnGetNodes()).each(function() {
		                ...
		                $(this).click(function() {
		                    ...
		                    buttons: {
		                        confirm: function () {
		                            onConfirmWhenDelete(aData['DepartmentId']);
		                        },
		                        cancel: function () {
		                            //$.alert('Canceled!');
		                        }
